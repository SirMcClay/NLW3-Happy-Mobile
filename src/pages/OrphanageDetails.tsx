...
export default function OrphanageDetails() {
  ...
  function handleOpenGoogleMapRoutes(latitude: number, longitude: number) {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={() => handleOpenGoogleMapRoutes(orphanage.latitude, orphanage.longitude)} style={styles.routesContainer}>
